$(function(){
	...
	$("div.top_img_div").hover(function(){
		$(this).css("borderColor","#E3007F").siblings("borderColor","#353535");
	},function(){
	...
	$(".title_ul li").mouseover(function(){
		$(this).parents("div.container").find("div.top_con").eq($(this).index()).show().siblings("div.top_con").hide();
	})
})
