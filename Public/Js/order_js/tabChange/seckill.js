...
*/
    ...
    $("#time_select").change(function(){
        ...
        status = $("#status").text();
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":status, "time_flag":checkvalue})            
    });

    //选择订单交易状态
    $("#all").click(function(){
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":"40"})            
        $("#status").text("40");
        $("#time_select").val(5);
        $("#search_text").val("");
    });
    ...
    $("#wait_pay").click(function(){
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":"0"})            
        $("#status").text("0");
        $("#time_select").val(5);
        $("#search_text").val("");
    });
    ...
    $("#wait_send").click(function(){
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":"1"})            
        $("#status").text("1");
        $("#time_select").val(5);
        $("#search_text").val("");
    });
    ...
    $("#wait_take").click(function(){
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":"2"})            
        $("#status").text("2");
        $("#time_select").val(5);
        $("#search_text").val("");
    });
    ...
    $("#wait_comment").click(function(){
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"status":"3"}) 
        $("#status").text("3");
        $("#time_select").val(5);
        $("#search_text").val("");
    });
    ...
    $("#search").click(function(){
        ...
        $("#order_content_margin").load("../TabChange/seckill #order_content", {"search_text":search_text}) 
    });
