<?php /* Smarty version Smarty-3.1.21, created on 2015-07-06 15:06:13
         compiled from "../../templates/system/system_info.html" */ ?>
<?php /*%%SmartyHeaderCode:2063483837555840e94ca239-22013666%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f3ae823c89161297f82b0825115aa1dce1859719' => 
    array (
      0 => '../../templates/system/system_info.html',
      1 => 1436166282,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2063483837555840e94ca239-22013666',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_555840e9515a34_89752679',
  'variables' => 
  array (
    'url' => 0,
    'array' => 0,
...
<?php if ($_valid && !is_callable('content_555840e9515a34_89752679')) {function content_555840e9515a34_89752679($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
/admin_manage/system_manage/system_modify.php" method="post" id="doForm">
				<p>网站全名：<input class="in1" type="text" name="web_name" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['web_name'];?>
" /></p>			
				 <p>网站关键字：
...
" /></p>
				<p>客服QQ：<input class="in1" type="text" name="qq" id="qq" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['qq'];?>
" /></p>
				<p>客服旺旺：<input class="in1" type="text" name="wangwang" id="wangwang" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['wangwang'];?>
" /></p>				
				<p>Email：<input class="in1" type="text" name="email" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['email'];?>
" /></p>
				<p>邮箱密码：<input class="in1" type="password" name="email_pass" id="name" value="<?php echo $_smarty_tpl->tpl_vars['array']->value['email_pass'];?>
" /></p>
