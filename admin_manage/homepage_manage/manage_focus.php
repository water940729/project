		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>location:homepage manage －&gt; <strong>focus manage</strong></span>
				</div>
				<div class="content">
					<table width="100%">
						<tr class="t1">
						...
						<?php
							$pagesize=20;							
							$select="select count(*) as page_count from homeFocus ".$area;
							...
							$sql1="select * from homeFocus ".$area." order by weight desc limit ".$pagestart.",".$pagesize;
