		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>location:trail manage －&gt; <strong>focus manage</strong></span>
				</div>
				<div class="content">
					<table width="100%">
						<tr class="t1">
						...
						<?php
							$pagesize=20;							
							$select="select count(*) as page_count from trail_focus ".$area;
							...
							$sql1="select * from trail_focus ".$area." order by weight desc limit ".$pagestart.",".$pagesize;
