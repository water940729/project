	...
	<head>
		...
		function searchGoods(){
			 ...
			 $.ajax({
				   ...
				   data: "action=search&type="+type+"&order="+order+"&orderBy="+orderBy+"&page="+page+'&mallId='+mallId,
		...
		<div class="bgintor" style='height:800px'>				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>位置：订单管理  <strong></strong></span>	
					...
					<input type='button' value='切换' onclick='changeMall()' />
					<?php
					    }
					?>
