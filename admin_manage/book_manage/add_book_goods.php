...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>位置：预售管理 －&gt; <strong>分类管理</strong> －&gt; <strong>添加商品</strong></span>
		</div>		
		<div class="fromcontent">
			<form action="add_book_goods_do.php" method="post" id="doForm">
...
function check()
{
	...
	if(form.goodsName.value!=""&&form.price.value!=""&&form.start.value!="")
	{
		form.submit();
	}	 
}
