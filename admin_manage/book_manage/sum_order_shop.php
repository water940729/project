...
while($row=mysql_fetch_array($res)){
     $shop_id=$row['id'];
	 $query1="select count(order_id) as total from book_orderlist where shop_id=$shop_id and state=0";
     $res1=mysql_query($query1);
	 $row1=mysql_fetch_array($res1);
	 $query1="select count(order_id) as total from book_orderlist where shop_id=$shop_id and state=1";
     $res2=mysql_query($query1);
	 $row2=mysql_fetch_array($res2);
	 $query1="select count(order_id) as total from book_orderlist where shop_id=$shop_id and state=2";
     $res3=mysql_query($query1);
	 $row3=mysql_fetch_array($res3);
	 $query1="select count(order_id) as total from book_orderlist where shop_id=$shop_id and state=3";
