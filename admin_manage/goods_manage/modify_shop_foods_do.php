<?php
	...
	*/
	...
	$sql="update goods_type3 set name='".$_POST[goods_type]."',attribute1='$attribute1',attribute2='$attribute2',attribute3='$attribute3',attribute4='$attribute4' where id=$_POST[id]";
	if(mysql_query($sql)){
