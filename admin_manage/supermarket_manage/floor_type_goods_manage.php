		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>位置：超市管理 －&gt; <strong>楼层管理</strong> －&gt; <strong>分类管理</strong> －&gt; <strong>商品管理</strong></span>
				</div>
				<div class="content">
					...
					<table width="100%">
						...
						<?php
							$pagesize=20;							
							$select="select count(*) as page_count from superPageGoods".$area;
							...
							$sql1="select * from superPageGoods".$area." order by weight desc limit ".$pagestart.",".$pagesize;
