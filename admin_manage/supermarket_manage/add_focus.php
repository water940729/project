<?php
	...
	$sql="select count(id) as total from super_goods_type1 where display=1";
		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>位置：超市管理 －&gt; <strong>添加焦点图</strong></span>
				</div>
				<div class="content">
					<form action="add_focus_do.php" method="post" id="doForm">
						...
						<p>焦点图上传: 
						 ...
						 <input type="file" name="file" id="file1_image"/>
							...
							class="btn btn-large btn-primary" />(图片大小210*<?php echo $height_num*60;?>)
						</p>
						<br/>
