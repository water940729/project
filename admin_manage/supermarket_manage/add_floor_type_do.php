<?php
	...
	*/
	...
	$sql="insert into super_floorTypeManage(typename,floor_id,floor_name,weight,type1_id,type1_name) values('{$_POST["type_name"]}',{$_POST["floor_id"]},'{$_POST["floor_name"]}',$weight,$type1_id,'{$type1_name}')";
	if(mysql_query($sql)){
		$content="超市楼层编号".$_POST["floor_id"]."添加分类".$_POST["type_name"];
