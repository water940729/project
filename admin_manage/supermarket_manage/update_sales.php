	...
	<div class="bgintor">
		<div class="tit1">				
			<ul>
				...
				<li class="l1"><a href="add_sales.php">添加公告</a> </li>
			</ul>		
		</div>
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>位置：公告管理 －&gt; <strong>修改公告</strong></span>
		</div>		
		<div class="fromcontent">
			<form action="do.php?act=update" method="post" id="doForm">
				<input type="hidden" name="id" value="<?php echo $id ?>">

				<p>公告标题：<input class="in1" type="text" name="title" id="title" value="<?php echo $row["title"] ?>"/></p>
				<p>商品详情:</p>
