		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>位置：超市管理 －&gt; <strong>关键词管理</strong></span>
				</div>
				<div class="content">
					<table width="100%">
						<tr class="t1">
						...
						<?php
							$pagesize=20;							
							$select="select count(*) as page_count from super_keyword_manage ".$area;
							...
							$sql1="select * from super_keyword_manage ".$area." order by weight desc limit ".$pagestart.",".$pagesize;
						...
						<tr>
							...
							<td><?php echo $time?>"</td>
							<td>
								<a href="javascript:void(0);" onclick="delete_keyword(<?php echo $id;?>)">删除</a>
							</td>
						</tr>
						<?php
							}	
