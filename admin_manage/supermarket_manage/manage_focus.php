		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>位置：超市管理 －&gt; <strong>焦点图管理</strong></span>
				</div>
				<div class="content">
					<table width="100%">
						<tr class="t1">
						...
						<?php
							$pagesize=20;							
							$select="select count(*) as page_count from superFocus ".$area;
							...
							$sql1="select * from superFocus ".$area." order by weight desc limit ".$pagestart.",".$pagesize;
