		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>position:SeckillManage －&gt; <strong>AddFocusPiture</strong></span>
				</div>
				<div class="content">
					<form action="add_focus_do.php" method="post" id="doForm">
						<p>SkipURL:<input class="in1" type="text" name="link_url"/></p><br/>
						<p>FocusPictureWeight:<input class="in1" type="text" name="weight" id="weight"/>(Input any number between 1 & 9999,the greater the value the focus more front,deault is 1)</p><br/>
						<p>FocusPictureUpload: 
						 ...
						 <input type="file" name="file" id="file1_image"/>
							...
							class="btn btn-large btn-primary" />(ImageSize:1190*210)
						</p>
						<br/>
