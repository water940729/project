...
?>
							<tr>
								...
								<td><a href="order_list_stats.php?state=0&type=mall&id=<?php echo $mall_id; ?>">NotPaied:
									<?php
										echo $row1["total"]?$row1["total"]:0;
								    ?>pieces </a>&nbsp;|&nbsp;<a href="order_list_stats.php?state=1&type=mall&id=<?php echo $mall_id; ?>">Paied:
									<?php
										echo $row2["total"]?$row2["total"]:0;
								    ?>pieces </a>&nbsp;|&nbsp;<a href="order_list_stats.php?state=2&type=mall&id=<?php echo $mall_id; ?>">Delivered:
									<?php
										echo $row3["total"]?$row3["total"]:0;
								    ?>pieces </a>&nbsp;|&nbsp;<a href="order_list_stats.php?state=3&type=mall&id=<?php echo $mall_id; ?>">Checked:
									<?php
										echo $row4["total"]?$row4["total"]:0;
								    ?>pieces </a>
								</td>
								<td>
								     <a href="order_list_stats.php?type=mall&id=<?php echo $mall_id; ?>">CheckAllOrder</a>
								</td>
								</tr>
							<?php }?>
						</table>
