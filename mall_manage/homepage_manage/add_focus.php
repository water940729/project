...
<div class="tit1">
			...
			<div class="listintor">
				...
				<div class="header1">
					<span>Position:HomepageManage －&gt; <strong>AddFocusPicture</strong></span>
				</div>
				<div class="content">
					<form action="add_focus_do.php" method="post" id="doForm">
						<p>SkipUrl:<input class="in1" type="text" name="link_url"/></p><br/>
						<p>FocusPictureWeight:<input class="in1" type="text" name="weight" id="weight"/>(Input any number between 1 & 9999,The larger the numerical focus picture the top,Default is 1)</p><br/>
						<p>FocusPictureUpload: 
						 ...
						 <input type="file" name="file" id="file1_image"/>
							...
							<input type="button" class="confirm" value="上传" onclick="return ajaxFileUpload1('image');" 
							class="btn btn-large btn-primary" />(ImageSize725*<?php echo $height_num*60-90;?>)
						</p>
						<br/>
