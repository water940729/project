					...
					$.ajax({
						...
						success:function(msg){
							...
							*/
							if(msg==0){
								//没有数据时
								alert("No such goods,input anothor keyword");
							}else{
								//alert("000");
								$("#search_result").empty();
								var id=$("#search_result").attr("name");
								var data="<table width='100%'><tr class='t1'><td width='5%' class='id'>GoodsNo.</td>"+
								"<td width='10%' class='name'>GoodsName</td>"+"<td width='10%'>StoreName</td>"+"<td width='10%'>NameOflevel1Sort</td>"+
								"<td width='10%'>NameOflevel2Sort</td>"+"<td width='10%'>NameOflevel3Sort</td>"+"<td width='10%'>Operation</td></tr>";
								for(var i in msg){
									data+="<tr>";
									for(var x in msg[i]){
										if(x=="name"){
		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>position:HomepageManage －&gt; <strong>FloorManage</strong> －&gt; <strong>SortManage</strong> －&gt; <strong>GoodsManage</strong></span>
				</div>
				<div class="content">
