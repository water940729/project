...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<script>
			function check(){
				...
				if(num<=0){
					...
					if(num<num1){
						alert("Too many Goods recommends over"+num+",please delete some recommends");
					}else{
						$.ajax({
							type:"POST",
							data:"num="+num,
			...
			$(function(){
				$("#add").click(function(){
					...
					if(num+num2<=now){
						...
						alert("Goods recommends has been full!");
					}
				});
	...
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>Position:GoodsManage －&gt; <strong>Recommends</strong></span>
		</div>
		<div class="fromcontent">
				<p><font style="font-size:15px;color:red">RecommendInfo:</font></p>
				<p>NumberOfRecommends:<span id="now"><?php $sql="select recomm_num,recomm_id from market_info where id=1";
			...
			<p><font style="font-size:15px;color:red">ModifyInfo:</font></p>
				<p>MunberOfRecommends<input class="in1" type="text" name="num" id="goodsNum"/></p>
