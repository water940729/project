...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>Position:MallManage －&gt; <strong>ModifyMall</strong></span>
		</div>		
		<div class="fromcontent">
			<form action="edit_mall_do.php" method="post" id="doForm">
				<input type="hidden" name="mall_id" value="<?=$mall_id?>" />
				<p>MallName:<input class="in1" type="text" name="name" id="name" value="<?=$row['name']?>"/></p>	
				<p>MallLogo:
				<?php 
				...
				<p>ContinueUploading: 
				 ...
				 <input type="file" name="file" id="file_image"/>
                    ...
                    class="btn btn-large btn-primary" />(*Post size:in 500*500)
				</p>	
				<br>
				MallAddress:		
				...
				<p>DetailAddress:
					<textarea rows="3" name="detailAddressInfo" cols="100" id="detailAddressInfo" placeholder="Don't need to repeat to fill address,should more than 5 characters,less than 120 characters">
						<?=$row["detail_address"]?>
					</textarea>
				</p>
				<p>MerchantIntroduction:
...
function check()
{
	...
	*/
	...
	{
		alert("Input the brief introduction of mall!");
