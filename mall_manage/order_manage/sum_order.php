...
?>
							<tr>
								<td><?php echo $val;?></td>   
								<td width='80%'><a href="./orderManage.php?shopId=<?php echo $key; ?>&type=0&cat=<?php echo $cat;?>">已下单
									<?php
										echo isset($data[$key][0])?$data[$key][0]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=1&cat=<?php echo $cat;?>">已支付
									<?php
										echo isset($data[$key][1])?$data[$key][1]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=2&cat=<?php echo $cat;?>">已发货：
									<?php
										echo isset($data[$key][2])?$data[$key][2]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=3&cat=<?php echo $cat;?>">已收货
									<?php
										echo isset($data[$key][3])?$data[$key][3]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=4&cat=<?php echo $cat;?>">待换货
									<?php
										echo isset($data[$key][4])?$data[$key][4]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=5&cat=<?php echo $cat;?>">已换货
									<?php
										echo isset($data[$key][5])?$data[$key][5]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=6&cat=<?php echo $cat;?>">待退货
									<?php
										echo isset($data[$key][6])?$data[$key][6]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=7&cat=<?php echo $cat;?>">已退货
									<?php
										echo isset($data[$key][7])?$data[$key][7]:0;
								    ?>件</a>&nbsp;|&nbsp;<a href="./orderManage.php?shopId=<?php echo $key; ?>&type=8&cat=<?php echo $cat;?>">已评价
									<?php
										echo isset($data[$key][8])?$data[$key][8]:0;
								    ?>件</a>
								</td>
								<td>
								     <a href="./orderManage.php?shopId=<?php echo $key; ?>&cat=<?php echo $cat;?>">查看</a>
								</td>
								</tr>
							<?php }?>
						</table>
