...
?>
							<tr>
								...
								<td><a href="order_list_stats.php?state=0&type=shop&id=<?php echo $shop_id; ?>">NotPaied:
								    ...
								    ?>pieces</a>&nbsp;|&nbsp;<a href="order_list_stats.php?state=3&type=shop&id=<?php echo $shop_id; ?>">Committed:
									<?php
										echo $row4["total"]?$row4["total"]:0;
								    ?>pieces</a>
								</td>
								<td>
								     <a href="order_list_stats.php?type=shop&id=<?php echo $shop_id; ?>">CheckAllOrders</a>
								</td>
								</tr>
							<?php }?>
						</table>
