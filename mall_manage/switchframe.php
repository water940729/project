...
<head>
	...
	<title>Show/Hide Leftside Navigationbar</title>
	<script language="JavaScript">
		function Submit_onclick(){
			if(window.top.document.getElementById('frams').cols == "205,7,*") {
				...
				document.getElementById("ImgArrow").alt="Show Leftside Navigationbar";
			} else {
				window.top.document.getElementById('frams').cols="205,7,*";
				document.getElementById("ImgArrow").src="images/switch_left.gif";
				document.getElementById("ImgArrow").alt="Hide Leftside Navigationbar";
			}
		}
...
<body>
	<div id="switchpic">
		<a href="javascript:Submit_onclick()"><img src="images/switch_left.gif" alt="Hide Leftside Navigationbar" id="ImgArrow" /></a>
	</div>
</body>
</html>
