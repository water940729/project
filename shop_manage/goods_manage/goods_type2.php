					...
					<table style="width:100%">
						...
						?>
							<tr>
								...
								<td><a href="<?php echo "goods_type3.php?id=$type1_id&&type_name=$type2_name&&type1_id=$type2_id";?>">View the subclass</a>|<a href="<?php echo "modify_shop_food.php?id=$type2_id";?>">Modify</a>|<a href="javascript:void(0);" onclick="delete_foods2(<?php echo $type2_id ?>)">Delete</a></td>
							</tr>
						<?php
						}
						?>
...
function check()
{
	...
	{
		alert('Please fill in the classification name!');
		form.name.focus();
		return false;
	}else{
		form.submit();
