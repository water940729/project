		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>Location: the mall management －&gt; <?php if($from=='mall'){ echo "View the shopping mall"; } ?>－&gt; Check the store－&gt; <strong>Check the shop goods</strong></span>
				</div>
				<div class="content">
					<p><h2>The current businesses:<?=$shop_name?></h2><p><br>
					<table width="100%">
						<tr class="t1">
							<td width="5%">Product ID</td>
							<td width="10%">Name</td>
							<td width="10%">Price</td>
							<td width="10%">Category 1</td>
							<td width="10%">Category 2</td>
							<td width="10%">Affiliated merchants</td>
							<td width="10%">Affiliated malls</td>
					...
					<?php }?>
					<br>
					<a href="<?=$url?>">Return to see the store</a>
				</div>
			</div>
		</div>
	</body>
