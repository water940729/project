...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>Location: Shop management －&gt; <strong>Modify the store</strong></span>
		</div>		
					...
					function(data,status){
						...
						if(data['result']==1){
							...
							document.getElementById('upd_pics').innerHTML= c + 
								"<p><img src='"+ info[1] +"' width='100'> <input type='checkbox' checked name='pics[]' value="+ data['sp_id'] +" /> "+info[1]+
								"</p>";
						}else{
