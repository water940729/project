...
测试
	...
	$insert="insert into seckill_goods(type_id,goodsname,mall,shop,keywords,price,introduction,img_url,start,end,num,description,extattribute1,extattribute2,extattribute3,role) 
	values($type_id,'{$goodsName}',$mall,$shop,'{$keyword}',$price,'{$goods_desc}','{$_POST["pics"][0]}',$start,$end,$num,'{$goods_info}','{$extattribute1}','{$extattribute2}','{$extattribute3}',$role)";
	...
	if(mysql_query($insert)){
		...
		$content="Added a second kill commodity, commodity information, commodity name".$goodsName;
