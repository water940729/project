		...
		<div class="bgintor">				
			<div class="listintor">
				...
				<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
					<span>Location: seckill management －&gt; <strong>Add focus figure</strong></span>
				</div>
				<div class="content">
					<form action="add_focus_do.php" method="post" id="doForm">
						<p>Jump URL:<input class="in1" type="text" name="link_url"/></p><br/>
						<p>Focus figure weight:<input class="in1" type="text" name="weight" id="weight"/>(Input number between 1 to 9999, the larger the numerical classification of the front, the default is 1)</p><br/>
						<p>Focus figure upload: 
						 ...
						 <input type="file" name="file" id="file1_image"/>
							...
							class="btn btn-large btn-primary" />(Image size is 1190*210)
						</p>
						<br/>
