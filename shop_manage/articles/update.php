	...
	<div class="bgintor">
		<div class="tit1">				
			<ul>
				...
				<li class="l1">><a href="add.php">Add article</a> </li>
			</ul>		
		</div>
	<div class="listintor">
		<div class="header1"><img src="../images/square.gif" width="6" height="6" alt="" />
			<span>Location: Article management －&gt; <strong>Modify article</strong></span>
		</div>		
		<div class="fromcontent">
			<form action="do.php?act=update" method="post" id="doForm">
				<input type="hidden" name="id" value="<?php echo $id ?>">

				<p>Title:<input class="in1" type="text" name="title" id="title" value="<?php echo $row["title"] ?>"/></p>
				<p>Description:</p>
