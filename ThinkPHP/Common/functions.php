 ...
 */
		...
		function checkorderstatus($ordid){
			...
			switch($tag){
				...
				case 1:$ordlist="super_orderlist";break;
				case 2:$ordlist="seckill_orderlist";break;
				case 3:$ordlist="teambuy_orderlist";break;
				case 4:$ordlist="trial_orderlist";break;
				case 5:$ordlist="book_orderlist";break;				
			}
		    $Ord=M($ordlist);
		    if($result=$Ord->where("merge_ordid=".$ordid)->field("ordstatus")->find()){
				...
				$result=$Ord->where('ordid='.$ordid)->field('ordstatus')->find();
				$ordstatus=$result["ordstatus"];
				if($ordstatus==1){
					return true;
				}else{
		...
		function orderhandle($parameter){
			...
			$goodsnum=num;
			switch($tag){
				case 0:$ordlist="orderlist";$goodstable="goods";$goodsnum="goodsnum";break;
				case 1:$ordlist="super_orderlist";$goodstable="super_goods";$goodsnum="goodsnum";break;
				case 2:$ordlist="seckill_orderlist";$goodstable="seckill_goods";break;
				case 3:$ordlist="teambuy_orderlist";$goodstable="teambuy_goods";break;
